...
ROLE_PERMISSIONS: dict[str, frozenset[Permission]] = {
    ...
    Role.GENERAL_MANAGER: _MANAGEMENT_PERMS
    | frozenset(
        {
            Permission.VIEW_ALL_LEAVE,
            Permission.VIEW_ALL_ATTENDANCE,
    ...
    Role.OFFICE_MANAGER: _ADMIN_OFFICE_PERMS
    | frozenset(
        {
            Permission.MANAGE_ANNOUNCEMENTS,
            Permission.VIEW_TEAM_REPORTS,
    ...
    Role.EXECUTIVE_ASSISTANT: _ADMIN_OFFICE_PERMS
    | frozenset(
        {
            Permission.VIEW_DEPARTMENT_REPORTS,
            Permission.VIEW_EMPLOYEE_DETAIL,
    ...
    Role.SALES_MANAGER: _MANAGEMENT_PERMS
    | _SALES_PERMS
    | frozenset(
        {
            Permission.VIEW_DEPARTMENT_REPORTS,
    ...
    Role.MARKETING_SPECIALIST: _SALES_PERMS
    | frozenset(
        {
    ...
    Role.OPERATIONS_MANAGER: _MANAGEMENT_PERMS
    | _OPERATIONS_PERMS
    | frozenset(
        {
            Permission.VIEW_DEPARTMENT_REPORTS,
    ...
    Role.LOGISTICS_COORDINATOR: _BASE
    | frozenset(
        {
            Permission.VIEW_INVENTORY,
            Permission.VIEW_LOGISTICS,
    ...
    Role.INVENTORY_CONTROLLER: _BASE
    | frozenset(
        {
            Permission.VIEW_INVENTORY,
            Permission.MANAGE_INVENTORY,
